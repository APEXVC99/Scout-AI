...
function PipelinePage() {
  const { companies: initialCompanies, scans: initialScans } =
    Route.useLoaderData();
    ...
    <div>
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="flex flex-col items-end">
          ...
          <div className="mt-2 flex items-center justify-end gap-1.5 text-xs text-gray-500 dark:text-gray-400">
            <svg
            ...
            <span>Auto-scan: daily at 6am UTC</span>
          </div>
        </div>
      </div>
        ...
        <div className="mb-6 rounded-xl border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-950">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-green-800 dark:text-green-200">
              Scan complete! Found {scanResult.companiesFound} companies,{" "}
              {scanResult.newCompanies} new.
            </span>
          </div>
        </div>
      )}
              ...
              <div className="mb-3 flex h-10 w-10 mx-auto items-center justify-center rounded-xl bg-indigo-50 dark:bg-indigo-950">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75-3.75V5.25m0 0V3m0 2.25a2.25 2.25 0 010 4.5m0-4.5a2.25 2.25 0 000 4.5"
                  />
                </svg>
              </div>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                No companies discovered yet. Click "Scan Now" to start sourcing
                deals.
              </p>
            </div>
          ) : (
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                  {companies.map((c) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-semibold ${sourceColor(c.source)}`}
                        >
                          {c.source}
                        </span>
                      </td>
